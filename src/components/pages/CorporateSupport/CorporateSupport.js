...
import {
  ...
  CorporateSupport,
  VoteOfThanks,
} from '@/data/config/corporateSupport';
              ...
              return (
                <div>
                  <div className={styles.CorpDiv} key={`corp_${idx_i}`}>
                    <a href={`${item_i.link}`}>
                      <img
                        src={`/images/corporateSupport/logo/${item_i.image}`}
                        alt=''
                  ...
                  <div className={styles.CorpDiv} key={`impl_${idx_i}`}>
                    <a href={`${item_i.implmentationPartner.link}`}>
                      <img
                        src={`/images/corporateSupport/logo/${item_i.implmentationPartner.image}`}
                        alt=''
                            ...
                            {item_i.facilities.map((item, idx) => {
                              return (
                                ...
                                >
                                  <div>
                                    <img
                                      src={`/images/corporateSupport/facilityUpdate/${item.image}`}
                                      alt=''
        ...
        return (
          <div key={`csr_${idx}`}>
            <div className={styles.CorpSupportMob}>
              <div
                style={{
                  backgroundImage: `url("/images/corporateSupport/facilityUpdate/${item.image}")`,
                }}
