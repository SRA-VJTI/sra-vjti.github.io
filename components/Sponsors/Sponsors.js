...
import { 
          ...
          goldSponsors, 
          silverSponsors,
          levelImages  } from '../../data/sponsors';
  ...
  return (
    <>
      <Hero
        ...
        title={<>Sponsors us</>}
        subtitleList={['Our sponsors helps us maintain our legacy of excellence']}
        isHome={false}
      />
      <div className={styles.activityList} id='is'>
        <div className={styles.reach}>
        <a href='https://media.geeksforgeeks.org/wp-content/cdn-uploads/20210101201653/PDF.pdf' target={'_blank'} download={'brochure'}>
            <button>
              Download Brochure <span><FontAwesomeIcon icon={faDownload} /></span>
            </button>
        </a>
            <h1>Sponsors</h1>
            <img
